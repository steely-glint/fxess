 ...
 */
public class Meter  {
//private BiFunction<String, SCTPStream, SCTPStreamListener> mapper;
static public Gauge make(Function<GaugeBuilder,GaugeBuilder> customize ) {
        /**
     ...
     */
    GaugeBuilder gb = GaugeBuilder.create()
            .prefSize(160,160)                                                               // Preferred size of control
